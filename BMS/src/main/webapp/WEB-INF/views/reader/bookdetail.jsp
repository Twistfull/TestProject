		...
		<div class="container-fluid">
			<div class="row">
			   <div class="col-sm-3 col-md-2 sidebar">
					...
					<div class="per_detail_content">
					      <ul class="media-list">
	                           <li class="media">
	                               ...
	                               <div class="media-body" style="padding:20px 10px 20px 50px;">
	                                   
	                                   <h3 class="media-heading">${Detail.bookName}详细信息</h3>	
	                                   <p class="sub-header"></p>                                 
	                                   <ul class="list-unstyled">
		                                   <li>作者:&nbsp;&nbsp;${Detail.bookAuthor}</li>
		                                     <p class="sub-header"></p>
		                                   <li>出版社:&nbsp;&nbsp;${Detail.bookPubl}</li>
		                                     <p class="sub-header"></p>
		                                   <li>书籍类型:&nbsp;&nbsp;${Detail.bookKind}</li>
		                                     <p class="sub-header"></p>		                                   
		                                   <li>出版日期:&nbsp;&nbsp;
		                                    <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt1"%><!-- 格式化日期 -->
										     <fmt1:formatDate value="${Detail.publDate}" pattern="yyyy-MM-dd"/>
		                                   </li>
		                                   <p class="sub-header"></p>
		                                   <li>图书价格:&nbsp;&nbsp;￥${Detail.bookPrice}</li>
		                                   <p class="sub-header"></p>
		                                   <li>在架位置:&nbsp;&nbsp;${Detail.bookAddress}</li>
		                                   <p class="sub-header"></p>
		                                   <li>入库时间:&nbsp;&nbsp;
		                                    <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt2"%><!-- 格式化日期,注意value里不要有空格 -->
										     <fmt2:formatDate value="${Detail.storageDate}" pattern="yyyy-MM-dd"/>
		                                  </li>
		                                     <p class="sub-header"></p>
		                                  <li>书籍简介:&nbsp;&nbsp;${Detail.bookIntro}</li>
		                                     <p class="sub-header"></p>
		                                  <li>书籍状态:&nbsp;&nbsp;${Detail.bookStatus}</li>
		                                     <p class="sub-header"></p>
	                                   </ul>
	                                 </div>
	                 <!--              </li>
                ...
                <!--     <input type="button" class="btn btn-primary" name="back" value="返回" onclick="javascript:history.back(-1);"/>
				</div>
			</div>
		</div> -->
