		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<h2 class="sub-header" id="successtip">错误信息</h2>
					      ...
					      <ul class="media-list">
	                           <li class="media">
	                               ...
	                               <div class="media-body" id="borrowdetail">
	                                   ...
	                                   <h5 class="media-heading">很抱歉你的操作我不能理解!</h3>	                                   
	                                   </ul>
	                                 </div>
	                              </li>
	                        </ul>
                     </div> 
                    <input type="button" class="btn btn-primary" name="back" value="确认" onclick="AddBorrow('confirm')"/>
                    <input type="button" class="btn btn-primary" name="back" value="取消" onclick="AddBorrow('cancel')" style="margin-left:20px;"/>
				</div>
			</div>
		</div>
